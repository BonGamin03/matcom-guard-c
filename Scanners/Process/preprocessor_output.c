# 0 "Scanners/Process/process_monitor.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "Scanners/Process/process_monitor.c"
...
# 2 "Scanners/Process/process_monitor.c" 2
...
# 3 "Scanners/Process/process_monitor.c" 2
...
# 4 "Scanners/Process/process_monitor.c" 2
...
# 5 "Scanners/Process/process_monitor.c" 2
...
# 6 "Scanners/Process/process_monitor.c" 2
...
# 7 "Scanners/Process/process_monitor.c" 2
...
# 8 "Scanners/Process/process_monitor.c" 2
# 1 "Scanners/Process/process_monitor.h" 1
...
# 8 "Scanners/Process/process_monitor.h"
typedef struct{
    int pid;
    char name[256];
    unsigned long last_user_time;
    unsigned long last_system_time;
...
void check_alert(void);
void show_report(void);
void process_handler(void);
void print_module(void);
void init_process(void);
# 9 "Scanners/Process/process_monitor.c" 2
# 1 "Scanners/Process/../../Scanners/util.h" 1



void Write_Alert(const char* message);
# 10 "Scanners/Process/process_monitor.c" 2
...
void load_config(){
    ...
    if(config_file == 
# 29 "Scanners/Process/process_monitor.c" 3 4
                     ((void *)0)
# 29 "Scanners/Process/process_monitor.c"
                         ){
...
# 72 "Scanners/Process/process_monitor.c" 3 4
   ((void *)0)

# 73 "Scanners/Process/process_monitor.c"
};
...
int is_whitelist_process(const char* name){
    if(!name) return 0;
    for(int i = 0;white_list[i] != 
# 107 "Scanners/Process/process_monitor.c" 3 4
                                  ((void *)0)
# 107 "Scanners/Process/process_monitor.c"
                                      ;i++){
        if(strstr(name,white_list[i]) != 
# 108 "Scanners/Process/process_monitor.c" 3 4
                                        ((void *)0)
# 108 "Scanners/Process/process_monitor.c"
                                            ){
            return 1;
        }
    }
...
int read_process(int pid,Process* process){
    ...
    unsigned long user_time, system_time , v_size ,rss;
    char temp_name[256];
    char state;
...
# 194 "Scanners/Process/process_monitor.c" 3 4
                                   _SC_NPROCESSORS_ONLN
# 194 "Scanners/Process/process_monitor.c"
                                                       );
...
# 237 "Scanners/Process/process_monitor.c" 3 4
                                        ((void *)0)
# 237 "Scanners/Process/process_monitor.c"
                                            ){
